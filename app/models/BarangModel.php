...
/**
 * BarangModel.php
 * Model untuk manajemen data barang / inventaris
 */
...
class BarangModel
{
    ...
    /**
     * Ambil barang berdasarkan kode barang
     */
    public function getByKode(string $kode): ?array
    {
        ...
        $stmt = $this->db->prepare($query);
        $stmt->bindParam(1, $kode, PDO::PARAM_STR);
        $stmt->execute();
    ...
    public function create(array $data): bool
    {
        try {
            ...
            error_log(
                'Error create barang: ' . $e->getMessage()
            );
    ...
    public function update(int $id, array $data): bool
    {
        try {
            ...
            error_log(
                'Error update barang: ' . $e->getMessage()
            );
    ...
    public function delete(int $id): bool
    {
        try {
            ...
            error_log(
                'Error delete barang: ' . $e->getMessage()
            );
    ...
    /**
     * Tambah / kurangi stok
     * Digunakan saat transaksi barang masuk / keluar
     */
    public function updateStok(
        ...
        try {
            ...
            error_log(
                'Error update stok barang: ' . $e->getMessage()
            );
